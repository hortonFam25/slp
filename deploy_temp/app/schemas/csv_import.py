...
class StudentCSVRow(BaseModel):
    ...
    grade_level: Optional[str] = Field(None, max_length=35, description="Grade level (K, 1, 2, etc.)")
...
def generate_caseload_template() -> str:
    """Generate a CSV template that matches the caseload.csv format from IEP legacy system"""
    headers = [
        'ID',
        'Last Name',
        'First Name', 
    ...
    sample_data = [
        {
            ...
            'Last Name': 'Doe',
            'First Name': 'John',
            'Grade': 'Kindergarten--full day',
            'Case Manager': 'Thompson,Sarah',
            'School': 'Example Elementary School',
            'Re Eval Most Recent': '7/17/2023',
            'Ann Rev Due Date': '3/25/2026',
            'Re Eval Due Date': '7/16/2026'
        },
        {
            'ID': '0159608386',
            'Last Name': 'Smith', 
            'First Name': 'Jane',
            'Grade': 'Early Childhood/Early On® (below kindergarten level)',
            'Case Manager': 'Johnson,Michael',
            'School': 'Example Elementary School',
            'Re Eval Most Recent': '12/13/2023',
            'Ann Rev Due Date': '3/18/2026', 
            'Re Eval Due Date': '12/12/2026'
        }
    ]
