...
class TherapySessionBase(BaseModel):
    ...
    start_time: Optional[datetime] = Field(None, description="Scheduled session start time (mirrors appointment when linked)")
    end_time: Optional[datetime] = Field(None, description="Scheduled session end time (mirrors appointment when linked)")
    actual_start_time: Optional[datetime] = Field(None, description="Actual session start time")
    actual_end_time: Optional[datetime] = Field(None, description="Actual session end time")
